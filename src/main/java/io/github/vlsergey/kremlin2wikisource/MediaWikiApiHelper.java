...
public class MediaWikiApiHelper {
    ...
    public void edit(String summary, String title, String content) throws Exception {
        ...
        editArgs.put("action", Collections.singletonList("edit"));
        editArgs.put("title", Collections.singletonList(title));
        editArgs.put("text", Collections.singletonList(content));
    ...
    private String fetchLgToken() throws AssertionError {
        ...
        final ResponseEntity<QueryTokensResponse> lgTokenResponse =
                restTemplate.getForEntity(this.apiEndpoint + "?action=query&meta=tokens&type=login&format=json",
                        QueryTokensResponse.class);
    ...
    public void login(String lgname, String lgpassword) throws AssertionError {
        ...
        final ResponseEntity<String> loginResponse =
                restTemplate.postForEntity(this.apiEndpoint, request, String.class);
